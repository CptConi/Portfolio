...
typeWriter
    ...
    .pauseFor(400)
    .typeString('<strong>Développeur <span style="color: #F06529;">HTML / CSS</span></strong>')
    .pauseFor(1000)
    .deleteChars(10)
    .pauseFor(200)
    .typeString('<strong><span style="color: #2965F1;">JavaScript / TypeScript</span></strong>')
    .pauseFor(1000)
    .deleteChars(23)
    .pauseFor(200)
    .typeString('<strong><span style="color: #A6120D;">Angular</span></strong>')
    .pauseFor(1000)
    .deleteChars(7)
    .pauseFor(200)
...
pfTimeline
    .from(pfTitre, { y: -50, opacity: 0, duration: 0.6 })
    .staggerFrom(pfItem, 1, { opacity: 0 }, 0.2);
...
// Animation Contact
const contactSection = document.querySelector('#parallax');
